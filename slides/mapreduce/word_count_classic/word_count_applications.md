...
A **word count** measures how many words 
appear in text. In real products, it’s 
both a user-facing feature and a basic 
backend operation.
...
This is why word count is a common MapReduce example: each worker can count its own documents independently, then the system adds the results together.
