...
| [`5_Data_Abstractions_in_Spark.pptx`](5_Data_Abstractions_in_Spark.pptx) | pptx  | Spark's data abstractions: Data → RDD, Data → DataFrame |
| [`6_what_is_an_RDD.pptx`](6_what_is_an_RDD.pptx) | pptx  | RDD vs. DataFrame: low-level/unstructured vs. high-level/structured data abstractions |
